// generated by pronto from plugins/pronto/scales/open-props-1.7.23 — do not edit
...
openprops: {
	source: {
		...
		origin:    "open-props"
		version:   "1.7.23"
		url:       "https://registry.npmjs.org/open-props/-/open-props-1.7.23.tgz"
	...
	buckets: {
		...
		ease: {
			...
			steps: {
				...
				"elastic-out-1": "cubic-bezier(.5,.75,.75,1.25)"
				"elastic-out-2": "cubic-bezier(.5,1,.75,1.25)"
				"elastic-out-3": "cubic-bezier(.5,1.25,.75,1.25)"
				"elastic-out-4": "cubic-bezier(.5,1.5,.75,1.25)"
				"elastic-out-5": "cubic-bezier(.5,1.75,.75,1.25)"
				"elastic-in-1": "cubic-bezier(.5,-0.25,.75,1)"
				"elastic-in-2": "cubic-bezier(.5,-0.50,.75,1)"
				"elastic-in-3": "cubic-bezier(.5,-0.75,.75,1)"
				"elastic-in-4": "cubic-bezier(.5,-1.00,.75,1)"
				"elastic-in-5": "cubic-bezier(.5,-1.25,.75,1)"
				"elastic-in-out-1": "cubic-bezier(.5,-.1,.1,1.5)"
				"elastic-in-out-2": "cubic-bezier(.5,-.3,.1,1.5)"
				"elastic-in-out-3": "cubic-bezier(.5,-.5,.1,1.5)"
				"elastic-in-out-4": "cubic-bezier(.5,-.7,.1,1.5)"
				"elastic-in-out-5": "cubic-bezier(.5,-.9,.1,1.5)"
				"step-1": "steps(2)"
				"step-2": "steps(3)"
				"step-3": "steps(4)"
				"step-4": "steps(7)"
				"step-5": "steps(10)"
				"elastic-1": "var(--ease-elastic-out-1)"
				"elastic-2": "var(--ease-elastic-out-2)"
				"elastic-3": "var(--ease-elastic-out-3)"
				"elastic-4": "var(--ease-elastic-out-4)"
				"elastic-5": "var(--ease-elastic-out-5)"
				"squish-1": "var(--ease-elastic-in-out-1)"
				"squish-2": "var(--ease-elastic-in-out-2)"
				"squish-3": "var(--ease-elastic-in-out-3)"
				"squish-4": "var(--ease-elastic-in-out-4)"
				"squish-5": "var(--ease-elastic-in-out-5)"
				...
				"circ-in": "cubic-bezier(.6,.04,.98,.335)"
				"circ-in-out": "cubic-bezier(.785,.135,.15,.86)"
				"circ-out": "cubic-bezier(.075,.82,.165,1)"
				"cubic-in": "cubic-bezier(.55,.055,.675,.19)"
				"cubic-in-out": "cubic-bezier(.645,.045,.355,1)"
				"cubic-out": "cubic-bezier(.215,.61,.355,1)"
				"expo-in": "cubic-bezier(.95,.05,.795,.035)"
				"expo-in-out": "cubic-bezier(1,0,0,1)"
				"expo-out": "cubic-bezier(.19,1,.22,1)"
				"quad-in": "cubic-bezier(.55,.085,.68,.53)"
				"quad-in-out": "cubic-bezier(.455,.03,.515,.955)"
				"quad-out": "cubic-bezier(.25,.46,.45,.94)"
				"quart-in": "cubic-bezier(.895,.03,.685,.22)"
				"quart-in-out": "cubic-bezier(.77,0,.175,1)"
				"quart-out": "cubic-bezier(.165,.84,.44,1)"
				"quint-in": "cubic-bezier(.755,.05,.855,.06)"
				"quint-in-out": "cubic-bezier(.86,0,.07,1)"
				"quint-out": "cubic-bezier(.23,1,.32,1)"
				"sine-in": "cubic-bezier(.47,0,.745,.715)"
				"sine-in-out": "cubic-bezier(.445,.05,.55,.95)"
				"sine-out": "cubic-bezier(.39,.575,.565,1)"
			}
		}
		layer: {
			prefix:    "--layer-"
